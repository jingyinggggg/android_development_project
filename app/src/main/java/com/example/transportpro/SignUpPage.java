...
public class SignUpPage extends AppCompatActivity {
        ...
        binding.signUpButton.setOnClickListener(v -> {
            ...
            if (termsCheckbox.isChecked()) {
                ...
                if (fullname.isEmpty() || username.isEmpty() || email.isEmpty() || contact.isEmpty() ||
                        password.isEmpty() || Rpassword.isEmpty() || !password.equals(Rpassword)) {
    ...
    private void incrementAndSaveUserId(String fullname, String username, String email, String contact, String password) {
        ...
        // Fetch last userId
        userIdReference.get().addOnCompleteListener(task -> {
            if (task.isSuccessful() && task.getResult().exists()) {
                int lastUserId = task.getResult().getValue(Integer.class);
                ...
                userIdReference.setValue(newUserId);
            } else {
                ...
                userIdReference.setValue(initialUserId);
            }
        });
    }
    ...
    private void setUserInDatabase(String username, User user) {
        reference.child(username).setValue(user).addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                loginIntent.putExtra("message", "Registration successful! Please verify your email.");
